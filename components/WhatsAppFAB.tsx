...
export default function WhatsAppFAB() {
    ...
    const message = encodeURIComponent("Hi! I'm interested in your event services.");
    ...
    return (
        ...
        >
            ...
            >
                ...
                {/* Main button */}
                <div className="relative w-14 h-14 bg-gradient-to-br from-green-400 to-green-600 rounded-full shadow-lg flex items-center justify-center">
                    {/* WhatsApp Icon */}
                    <svg
